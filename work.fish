...
# tmux new-window -n "docker" "cd ~/Projects/lusi/ && fish"
# tmux split-window -v "cd ~/Projects/lusi/ && fish"
# tmux split-window "cd ~/Projects/levi/ && fish"
# tmux split-window -v "cd ~/Projects/levi/ && fish"
# tmux select-layout -t "docker" "tiled"
