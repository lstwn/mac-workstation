...
if (do -i { tmux switch-client -t $session_name } | complete | get stderr | is-empty) {
...
tmux new-window   -d -n $container_pane_name ("cd ~/Projects/lusi/; " + $sleep_cmd + "; do -i { yarn docker:cassandra:up; }; " + $shell_cmd)
tmux split-window -h -t $container_pane_name ("cd ~/Projects/lusi/; " + $sleep_cmd + "; do -i { yarn docker:rabbitmq:up; }; " + $shell_cmd)
tmux split-window -h -t $container_pane_name ("cd ~/Projects/lusi/; " + $sleep_cmd + "; do -i { yarn docker:minio:up; }; " + $shell_cmd)
